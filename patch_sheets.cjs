const fs = require('fs');
let code = fs.readFileSync('src/services/googleSheetsResultsSync.ts', 'utf-8');

const newCode = `import { getAllSchoolStudentRecords } from './studentDatabaseService';
...
fs.writeFileSync('src/services/googleSheetsResultsSync.ts', newCode);
